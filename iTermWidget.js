...
const NAME = 'TODO';
const WEATHER_API_KEY = 'TODO'; // https://home.openweathermap.org/api_keys (One Call account needed)
...
function createWidget(data) {
  ...
  // // Line 6 - Prayer
  // const prayerLine = stack.addText(`🧎‍♂️ | ${data.prayer}`);
  // prayerLine.textColor = new Color(COLORS.prayer);
  // prayerLine.font = new Font(FONT_NAME, FONT_SIZE);
...
async function fetchData() {
  ...
  // // Get prayer data
  // const prayer = await fetchprayerData();
...
/**
 * Fetch data from the prayer calendar and determine number of days until prayer start/end.
 */
